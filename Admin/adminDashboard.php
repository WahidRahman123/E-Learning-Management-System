...
?>
  ...
  echo '<table class="table">
    ...
    echo '<tr>';
      ...
      echo '<td><form action="" method="POST" onclick="checker()" class="d-inline"><input type="hidden" name="id" value='. $row["co_id"] .'><button type="submit" class="btn btn-secondary" name="delete" value="Delete"><i class="far fa-trash-alt"></i></button></form></td>';
      echo '</tr>';
    }
  echo '</tbody>
  </table>';
