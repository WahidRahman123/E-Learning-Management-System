   ...
   <nav class="col-sm-3 col-md-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'addCategory') {echo 'active';} ?>" href="addCategory.php">
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'manageCategory') {echo 'active';} ?>" href="categoryList.php">
       <i class="fas fa-bars"></i>
       Manage Category
       </a>
      </li>
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'stream') {echo 'active';} ?>" href="stream/index.html" target="_blank">
       <i class="fab fa-accessible-icon"></i>
        Start Stream
       </a>
      </li>
