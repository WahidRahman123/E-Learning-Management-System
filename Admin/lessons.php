          ...
          echo '<table class="table">
            ...
            <tbody>';
              while($row = $result->fetch_assoc()){
                ...
                <form action="" method="POST" onclick="checker()" class="d-inline"><input type="hidden" name="id" value='. $row["lesson_id"] .'><button type="submit" class="btn btn-secondary" name="delete" value="Delete"><i class="far fa-trash-alt"></i></button></form></td>
              </tr>';
              }
              echo '</tbody>
             </table>';
