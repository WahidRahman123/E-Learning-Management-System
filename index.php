      ...
      <div class="container-fluid mt-5" style="background-color: #4B7289" id="Feedback">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <?php 
              $sql = "SELECT s.stu_name, s.stu_occ, s.stu_img, f.f_content FROM student AS s JOIN feedback AS f ON s.stu_id = f.stu_id AND f.status='1'";
              $result = $conn->query($sql);
              if($result->num_rows > 0) {
                while($row = $result->fetch_assoc()){
                  $s_img = $row['stu_img'];
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p><i>Bangladesh Army University of Science & Technology</i> <br> Saidpur Cantonment <br> Saidpur, Nilphamari <br> Ph. 000000000 </p>
          </div>
        </div>
      </div>
